      ...
      */}
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto overflow-x-hidden mt-4 scrollbar-hide flex flex-col gap-6">
            ...
            <div className="space-y-1">
              ...
              {puede('fiados') && (
                <button
                  ...
                  title={!isSidebarOpen ? 'Fiados (Crédito)' : ''}
                >
                  <span className="material-symbols-outlined !text-xl shrink-0">credit_card_off</span>
                  <span className={`text-sm whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 ml-3 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:ml-0'}`}>
                    Fiados (Crédito)
                  </span>
                </button>
              ...
              {puede('devoluciones') && (
                <button
                  ...
                  title={!isSidebarOpen ? 'Devoluciones' : ''}
                >
                  <span className="material-symbols-outlined !text-xl shrink-0">assignment_return</span>
                  <span className={`text-sm whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 ml-3 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:ml-0'}`}>
                    Devoluciones
                  </span>
                </button>
          ...
          {(puede('cupones') || puede('combos')) && (
            <div className="px-4">
              ...
              <div className="space-y-1">
                {puede('cupones') && (
                  <button
                    onClick={() => { navigate('/admin/cupones'); setIsMobileMenuOpen(false); }}
                    className={`nav-link w-full flex items-center h-11 rounded-xl transition-colors animate-hover animate-press pl-[14px] ${location.pathname === '/admin/cupones' ? 'bg-primary text-on-primary font-medium' : 'text-on-surface-variant hover:bg-on-surface/5'}`}
                    title={!isSidebarOpen ? 'Cupones' : ''}
                  >
                    <span className="material-symbols-outlined !text-xl shrink-0">confirmation_number</span>
                    <span className={`text-sm whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 ml-3 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:ml-0'}`}>
                      Cupones
                    </span>
                  </button>
                ...
                {puede('combos') && (
                  <button
                    onClick={() => { navigate('/admin/combos'); setIsMobileMenuOpen(false); }}
                    className={`nav-link w-full flex items-center h-11 rounded-xl transition-colors animate-hover animate-press pl-[14px] ${location.pathname === '/admin/combos' ? 'bg-primary text-on-primary font-medium' : 'text-on-surface-variant hover:bg-on-surface/5'}`}
                    title={!isSidebarOpen ? 'Combos' : ''}
                  >
                    <span className="material-symbols-outlined !text-xl shrink-0">redeem</span>
                    <span className={`text-sm whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 ml-3 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:ml-0'}`}>
                      Combos
                    </span>
                  </button>
          ...
          {puede('inventario') && (
            <div className="px-4">
              ...
              <div className="space-y-1">
                ...
                {puede('traspasos') && (
                  <button
                    onClick={() => { navigate('/admin/traspasos'); setIsMobileMenuOpen(false); }}
                    className={`nav-link w-full flex items-center h-11 rounded-xl transition-colors animate-hover animate-press pl-[14px] ${location.pathname === '/admin/traspasos' ? 'bg-primary text-on-primary font-medium' : 'text-on-surface-variant hover:bg-on-surface/5'}`}
                    title={!isSidebarOpen ? 'Traspasos de Sucursal' : ''}
                  >
                    <span className="material-symbols-outlined !text-xl shrink-0">sync_alt</span>
                    <span className={`text-sm whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 ml-3 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:ml-0'}`}>
          ...
          {(puede('usuarios') || puede('auditoria')) && (
            <div className="px-4">
              <h3 className={`font-label-sm text-[10px] text-outline uppercase tracking-widest whitespace-nowrap overflow-hidden transition-[max-width,opacity,margin] duration-300 ease-in-out max-w-[200px] opacity-100 mb-3 px-4 ${isSidebarOpen ? '' : 'md:max-w-0 md:opacity-0 md:mb-0 md:px-0 md:h-0'}`}>
                Administración
              </h3>
